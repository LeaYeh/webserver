...
ConfigHttpBlock::ConfigHttpBlock() :
    ...
    _error_page("./www/html/error_page.html"),
...
void ConfigHttpBlock::printConfig(void) const
{
    ...
    weblog::Logger::log(weblog::DEBUG, "\terror_page: " + _error_page);
...
std::string ConfigHttpBlock::errorPage(void) const
{
    return (_error_page);
}
...
void ConfigHttpBlock::_parseConfigDirective(const std::string& line)
{
    ...
    if (directive == "client_max_body_size") {
        ...
        _error_page = _parseErrorPage(line);
    }
...
std::string ConfigHttpBlock::_parseErrorPage(const std::string& line)
{
    std::string directive = _getDirectiveName(line);
    std::string value = extract_directive_value(line, directive);
