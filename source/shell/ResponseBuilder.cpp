                             ...
                             const std::string& body, bool body_only)
{
    ...
    else
    {
        ...
        // response.setHeader("Content-Type", _negotiate_content_type(headers));
        response.setBody(body);
    }
...
//     StatusCode status_code, const std::map<std::string, std::string>&
//     headers, const std::string& body, bool body_only)
// {
//     Response response;
